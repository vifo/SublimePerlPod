...
POD_TEXT_RENDERER_PATH = os.path.join(
    sublime.packages_path(), PLUGIN_NAME, 'lib', 'perl_pod', 'preview_renderers', 'perl', 'bin', 'pod_text.pl')


class PerlPodPodTextPreviewRenderer(PerlPodBasePreviewRenderer):
